...
| **Sector 4 (💻 파운데이션 모델·엔터프라이즈 SW)** | **[[04-파운데이션모델-엔터프라이즈SW.canvas|💻 Sector 4 캔버스]]** | xAI Grok, GPT-6 아스트라, o1/o3 추론 연산, Computer Use, OpenAI, xAI, Anthropic |
...
### 4. 💻 AI 엔터프라이즈 SW & 파운데이션 모델 (Sector 4: T4, 7개)
| ID | 가설 제목 | 스택 | 성격 | 핵심 기업 | 주요 연관 테제 |
|:---|:---|:---:|:---:|:---|:---|
