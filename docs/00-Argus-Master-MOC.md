...
tags:
  ...
  - jensen-huang-5layer-stack
---

# 🧭 Argus Pulse 투자 테제 Master MOC (Map of Content)

> **Argus Nexus 중앙 사령탑 (젠슨 황 5단 케이크 + 거시 환경 6대 섹터 체제)**  
> AI 및 첨단 기술 산업의 구조적 변화를 추적하는 **총 43개 투자 가설(Theses)**의 상호 인과관계 맵과 **6대 섹터(T1~T6) & 6계층 수직 스택(L0~L5) 다차원 대시보드** 사령탑입니다.

---

## 🗺️ 전체 가설 생태계 가치사슬 구조도 (Jensen Huang 5-Layer Stack & Macro Value Chain)

```mermaid
flowchart BT
    subgraph MacroGeopolitics["🏛️ 매크로 자본시장, 금리 & 지정학 안보 (T6)"]
        T6_01["[[T6-01-금리와-데이터센터|T6-01 금리와 DC ROI]]"]
        T6_02["[[T6-02-엔비디아와-GPU-금융|T6-02 GPU 금융]]"]
        T6_03["[[T6-03-AI-버블-가능성|T6-03 AI 버블 리스크]]"]
    ...
    subgraph Layer5["🤖 피지컬 AI, 모빌리티 & 로보틱스 (T5 / L5)"]
    ...
    subgraph Layer4["💻 파운데이션 모델 & 엔터프라이즈 SW (T4 / L4)"]
    ...
    subgraph Layer3["🌐 초고속 네트워킹 & 시스템 플랫폼 (T3 / L3)"]
    ...
    subgraph Layer2["💾 AI 컴퓨트, 메모리 & 선단 반도체 (T2 / L0~L1)"]
    ...
    subgraph Layer1["⚡ AI 데이터센터 & 전력·냉각 인프라 (T1 / L2)"]
    ...
    MacroGeopolitics -. 자본공급/ROI회수 .-> Layer1
    MacroGeopolitics -. 수출규제/지정학 .-> Layer2
```
...
> 43개 정식 테제 밖에서 새롭게 감지되어 검증·보육 중인 **차세대 후보 가설(`TC-XX`)** 목록입니다.
...
- **[[Vs-GPU-vs-TPU-ASIC|⚔️ 범용 GPU (NVIDIA) vs 커스텀 ASIC (빅테크 자체 칩)]]**: `T2-07`, `T2-08`, `T3-04`, `T4-04`
- **[[Vs-TSMC동맹-vs-삼성턴키|⚔️ TSMC 동맹 (SK-TSMC) vs 삼성전자 턴키 (원팀)]]**: `T2-01`, `T2-02`, `T2-04`
- **[[Vs-공랭-vs-액체냉각|⚔️ 레거시 공랭식 vs 직접액체냉각 (DLC & CDU)]]**: `T1-01`, `T1-02`, `T1-07`
...
## 🎨 6대 섹터 인터랙티브 캔버스 (Interactive Sector Canvases)

> 마우스로 자유롭게 노드를 탐색하고 기업·기술·테제 간 연결망을 시각적으로 조망할 수 있는 **섹터별 2D 시각화 보드**입니다.

- **[[01-에너지-전력-냉각-인프라.canvas|⚡ Sector 1. AI 데이터센터 & 전력·냉각 인프라 캔버스 (T1)]]**
- **[[02-AI컴퓨트-메모리-선단반도체.canvas|💾 Sector 2. AI 컴퓨트 · 메모리 · 선단 반도체 캔버스 (T2)]]**
- **[[03-초고속네트워킹-시스템플랫폼.canvas|🌐 Sector 3. 초고속 네트워킹 & 시스템 플랫폼 캔버스 (T3)]]**
- **[[04-파운데이션모델-엔터프라이즈SW.canvas|💻 Sector 4. 파운데이션 모델 & 엔터프라이즈 SW 캔버스 (T4)]]**
- **[[05-피지컬AI-자율주행-로보틱스.canvas|🤖 Sector 5. 피지컬 AI · 자율주행 · 로보틱스 캔버스 (T5)]]**
- **[[06-매크로-밸류에이션-지정학안보.canvas|🏛️ Sector 6. 매크로 자본시장 · 밸류에이션 · 지정학 안보 캔버스 (T6)]]**

---

## 📂 6대 섹터별 테제 인덱스 (총 43개)

### 1. ⚡ AI 데이터센터 & 전력·냉각 인프라 (T1, 8개 | 젠슨 황 1단)
...
### 2. 💾 AI 컴퓨트, 메모리 & 선단 반도체 (T2, 10개 | 젠슨 황 2단)
| ID | 가설 제목 | 스택 | 성격 | 핵심 기업 | 주요 연관 테제 |
|:---|:---|:---:|:---:|:---|:---|
...
### 3. 🌐 초고속 네트워킹 & 시스템 플랫폼 (T3, 4개 | 젠슨 황 3단)
| ID | 가설 제목 | 스택 | 성격 | 핵심 기업 | 주요 연관 테제 |
|:---|:---|:---:|:---:|:---|:---|
...
### 4. 💻 파운데이션 모델 & 엔터프라이즈 SW (T4, 4개 | 젠슨 황 4단)
| ID | 가설 제목 | 스택 | 성격 | 핵심 기업 | 주요 연관 테제 |
|:---|:---|:---:|:---:|:---|:---|
...
### 5. 🤖 피지컬 AI, 모빌리티 & 로보틱스 (T5, 9개 | 젠슨 황 5단)
| ID | 가설 제목 | 스택 | 성격 | 핵심 기업 | 주요 연관 테제 |
|:---|:---|:---:|:---:|:---|:---|
...
### 6. 🏛️ 매크로 자본시장, 금리 & 지정학 안보 (T6, 8개 | 거시 외생 환경)
| ID | 가설 제목 | 스택 | 성격 | 핵심 기업 | 주요 연관 테제 |
|:---|:---|:---:|:---:|:---|:---|
