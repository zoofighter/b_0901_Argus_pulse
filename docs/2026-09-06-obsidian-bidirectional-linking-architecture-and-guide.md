...
```mermaid
graph LR
    T01["[[T1-01-데이터센터의-변화|T-01 DC 전력/냉각 병목]]"] --> T02["[[T2-01-메모리-산업의-변화|★ T-02 HBM4 ASIC화]]"]
    T02 --> T10["[[T2-02-첨단-패키징과-CoWoS의-병목|T-10 CoWoS 패키징 병목]]"]
    T02 --> T35["[[T2-10-메모리-2028년-피크아웃|T-35 2028 메모리 피크아웃]]"]
```

- 🔼 **선행 가설 (상위 인프라 수요)**:
  - [[T1-01-데이터센터의-변화|T-01 데이터센터의 변화]] — 연산 병목의 메모리 전이
- ➡️ **동반 및 대체 가설**:
  - [[T2-06-CXL-메모리의-확대|T-07 CXL 메모리의 확대]] — CXL 메모리 풀링 병행
  - [[T6-07-중국반도체의-HBM-생산가능성|T-36 중국 반도체의 HBM 생산 가능성]] — 후발주자 추격 리스크
- 🔽 **파생 및 후행 병목 가설**:
  - [[T2-02-첨단-패키징과-CoWoS의-병목|T-10 첨단 패키징과 CoWoS의 병목]] — 베이스 다이 결합 병목
  - [[T2-10-메모리-2028년-피크아웃|T-35 메모리 2028년 피크아웃]] — 2028년 사이클 피크아웃 논쟁
...
- [[T2-01-메모리-산업의-변화|T-02 메모리 산업의 변화 (핵심 수혜)]]
- [[T2-06-CXL-메모리의-확대|T-07 CXL 메모리의 확대]]
- [[T2-02-첨단-패키징과-CoWoS의-병목|T-10 첨단 패키징과 CoWoS의 병목]]
- [[T2-10-메모리-2028년-피크아웃|T-35 메모리 2028년 피크아웃]]
...
## 🔗 연관 투자 테제 매핑
- [[T2-01-메모리-산업의-변화|T-02 메모리 산업의 변화]]
- [[T2-02-첨단-패키징과-CoWoS의-병목|T-10 첨단 패키징과 CoWoS의 병목]]
- [[T2-03-유리기판의-차세대-패키징-침투|T-11 유리기판의 차세대 패키징 침투]]
