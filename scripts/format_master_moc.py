...
MOC_PATH = Path("thesis/00-Argus-Master-MOC.md")
DOCS_MOC_PATH = Path("docs/00-Argus-Master-MOC.md")
...
> **Argus Nexus 중앙 사령탑**  
> AI 및 첨단 기술 산업의 구조적 변화를 추적하는 **총 45개 투자 가설(Theses)**의 상호 인과관계 맵과 **6대 섹터 & 5대 교차 차원(다차원 대시보드)** 사령탑입니다.  
...
flowchart TB
    ...
    subgraph SoftwareAgents["💻 AI 엔터프라이즈 SW & 파운데이션 모델 (T4)"]
        ...
        T4_03["[[T4-03-추론-시간-연산과-시스템2-추론-모델의-부상|T4-03 o1/o3 추론 연산 스케일링]]"]
        T4_04["[[T4-04-자율형-에이전트와-컴퓨터-제어-엔터프라이즈-침투|T4-04 Computer Use & 자율 에이전트]]"]
...
| **Sector 4 (💻 파운데이션 모델·엔터프라이즈 SW)** | **[[04-파운데이션모델-엔터프라이즈SW.canvas|💻 Sector 4 캔버스]]** | o1/o3 추론 연산, Computer Use, 옴니 네이티브, 사설 AI, OpenAI, Anthropic, Microsoft |
...
> 45개 정식 테제 밖에서 새롭게 감지되어 검증·보육 중인 **차세대 후보 가설(`TC-XX`)** 목록입니다.
...
### 4. 💻 AI 엔터프라이즈 SW & 파운데이션 모델 (Sector 4: T4, 5개)
| ID | 가설 제목 | 스택 | 성격 | 핵심 기업 | 주요 연관 테제 |
|:---|:---|:---:|:---:|:---|:---|
...
| **[[T4-02-AI-소프트웨어-레이어의-과점화|T4-02]]** | AI 소프트웨어 레이어의 과점화 | `L4` | `🚀 주류` | `[[Company-Microsoft|Microsoft]]`, `[[Company-Alphabet|Alphabet]]` | `[[T4-03-추론-시간-연산과-시스템2-추론-모델의-부상|T4-03]]`, `[[T4-04-자율형-에이전트와-컴퓨터-제어-엔터프라이즈-침투|T4-04]]` |
| **[[T4-03-추론-시간-연산과-시스템2-추론-모델의-부상|T4-03]]** | 추론 시간 연산과 시스템 2 추론 모델의 부상 | `L4` | `🚀 주류` | `[[Company-OpenAI|OpenAI]]`, `[[Company-Anthropic|Anthropic]]` | `[[T2-07-AI-추론-시장-폭발과-LPU-ASIC-분화|T2-07]]`, `[[T4-04-자율형-에이전트와-컴퓨터-제어-엔터프라이즈-침투|T4-04]]` |
| **[[T4-04-자율형-에이전트와-컴퓨터-제어-엔터프라이즈-침투|T4-04]]** | 자율형 에이전트와 컴퓨터 제어의 침투 | `L4` | `🚀 주류` | `[[Company-Anthropic|Anthropic]]`, `[[Company-OpenAI|OpenAI]]` | `[[T4-02-AI-소프트웨어-레이어의-과점화|T4-02]]`, `[[T5-02-행동형-AI-에이전트와-모바일-교체-슈퍼사이클|T5-02]]` |
...
### 6. 🏛️ 매크로 자본시장, 금리 & 지정학 안보 (Sector 6: T6, 9개)
| ID | 가설 제목 | 스택 | 성격 | 핵심 기업 | 주요 연관 테제 |
|:---|:---|:---:|:---:|:---|:---|
...
| **[[T6-03-AI-버블-가능성|T6-03]]** | AI 버블 가능성 (CAPEX ROI 불일치) | `L3` | `🛡️ 헷지` | `[[Company-NVIDIA|NVIDIA]]`, `[[Company-BigTech|빅테크]]` | `[[T6-01-금리와-데이터센터|T6-01]]`, `[[T6-09-엔비디아와-네오클라우드|T6-09]]`, `[[T6-02-엔비디아와-GPU-금융|T6-02]]` |
...
| **[[T6-05-오픈AI·앤트로픽의-5000억달러-매출-갭과-데이터센터-ROI-딜레마|T6-05]]** | 오픈AI·앤트로픽의 5000억$ 매출 갭 | `L3` | `🛡️ 헷지` | `[[Company-OpenAI|OpenAI]]`, `[[Company-Anthropic|Anthropic]]` | `[[T6-03-AI-버블-가능성|T6-03]]`, `[[T4-02-AI-소프트웨어-레이어의-과점화|T4-02]]`, `[[T2-11-TPU-증가와-GPU-수요-둔화|T2-11]]` |
...
MOC_PATH.write_text(NEW_MOC_CONTENT.strip() + "\n", encoding="utf-8")
if DOCS_MOC_PATH.parent.exists():
    DOCS_MOC_PATH.write_text(NEW_MOC_CONTENT.strip() + "\n", encoding="utf-8")

print("00-Argus-Master-MOC.md successfully updated with 45 theses.")
