...
```mermaid
graph LR
    P_T_01["[[T1-01-데이터센터의-변화|T1-01 데이터센터의 변화]]"] --> T_T_29["★ [[T3-02-초고속-AI-네트워킹-UEC-vs-인피니밴드|T3-02 초고속 AI 네트워킹 UEC vs 인피니밴드]]"]
    P_T_14["[[T3-01-실리콘-포토닉스와-CPO의-상용화|T3-01 실리콘 포토닉스와 CPO의 상용화]]"] --> T_T_29["★ [[T3-02-초고속-AI-네트워킹-UEC-vs-인피니밴드|T3-02 초고속 AI 네트워킹 UEC vs 인피니밴드]]"]
```
