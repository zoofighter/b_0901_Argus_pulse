...
```mermaid
graph LR
    P_T_01["[[T-01-데이터센터의-변화|T-01 데이터센터의 변화]]"] --> T_T_22["★ [[T-22-AI-전력망용-대용량-ESS와-LFP-공급망|T-22 AI 전력망용 대용량 ESS와 LFP 공급망]]"]
    T_T_22["★ [[T-22-AI-전력망용-대용량-ESS와-LFP-공급망|T-22 AI 전력망용 대용량 ESS와 LFP 공급망]]"] --> D_T_32["[[T-32-ESS와-한국배터리의-미국수혜|T-32 ESS와 한국 배터리의 미국 수혜]]"]
    T_T_22["★ [[T-22-AI-전력망용-대용량-ESS와-LFP-공급망|T-22 AI 전력망용 대용량 ESS와 LFP 공급망]]"] <.-> S_T_23["[[T-23-변압기-초고압-그리드-쇼티지-장기화|T-23 변압기·초고압 그리드 쇼티지 장기화]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T-01-데이터센터의-변화|T-01 데이터센터의 변화]] — 데이터센터 전력 피크 및 간헐성 문제
- ➡️ **동반 및 대체·경쟁 가설**:
  - [[T-23-변압기-초고압-그리드-쇼티지-장기화|T-23 변압기·초고압 그리드 쇼티지 장기화]] — 그리드 안정화 보완
- 🔽 **파생 및 후행 병목 가설**:
  - [[T-32-ESS와-한국배터리의-미국수혜|T-32 ESS와 한국 배터리의 미국 수혜]] — 북미 LFP/NCM ESS 수혜
...
WHERE contains(thesis, "T-22") OR contains(file.outlinks, this.file.link)
