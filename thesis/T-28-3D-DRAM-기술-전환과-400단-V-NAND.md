...
confidence: 65
direction: bullish
hypothesis: 미세화 한계에 도달한 2D 평면 DRAM이 3D 적층 DRAM으로 전환을 시작하며 신소재 및 ALD 원자층 증착 장비 수요가
  폭발한다
id: T-28
keywords:
- 3D DRAM
...
title: 3D DRAM 기술 전환과 400단 V-NAND
aliases:
- T-28
- T-28 3D DRAM 기술 전환과 400단 V-NAND
- 3D DRAM 기술 전환과 400단 V-NAND
...
```mermaid
graph LR
    P_T_02["[[T-02-메모리-산업의-변화|T-02 메모리 산업의 변화]]"] --> T_T_28["★ [[T-28-3D-DRAM-기술-전환과-400단-V-NAND|T-28 3D DRAM 기술 전환과 400단 V-NAND]]"]
    P_T_07["[[T-07-CXL-메모리의-확대|T-07 CXL 메모리의 확대]]"] --> T_T_28["★ [[T-28-3D-DRAM-기술-전환과-400단-V-NAND|T-28 3D DRAM 기술 전환과 400단 V-NAND]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T-02-메모리-산업의-변화|T-02 메모리 산업의 변화]] — 1c/1d nm D램 미세화 한계
  - [[T-07-CXL-메모리의-확대|T-07 CXL 메모리의 확대]] — 초고용량 메모리 적층 요구
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - (해당 없음)
...
WHERE contains(thesis, "T-28") OR contains(file.outlinks, this.file.link)
