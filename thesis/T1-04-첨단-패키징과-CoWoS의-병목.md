...
```mermaid
graph LR
    P_T_01["[[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]]"] --> T_T_10["★ [[T1-04-첨단-패키징과-CoWoS의-병목|T1-04 첨단 패키징과 CoWoS의 병목]]"]
    P_T_02["[[T1-01-메모리-산업의-변화|T1-01 메모리 산업의 변화]]"] --> T_T_10["★ [[T1-04-첨단-패키징과-CoWoS의-병목|T1-04 첨단 패키징과 CoWoS의 병목]]"]
    T_T_10["★ [[T1-04-첨단-패키징과-CoWoS의-병목|T1-04 첨단 패키징과 CoWoS의 병목]]"] --> D_T_11["[[T1-05-유리기판의-차세대-패키징-침투|T1-05 유리기판의 차세대 패키징 침투]]"]
    T_T_10["★ [[T1-04-첨단-패키징과-CoWoS의-병목|T1-04 첨단 패키징과 CoWoS의 병목]]"] --> D_T_16["[[T1-08-파운드리-2nm-공정과-GAA-격돌|T1-08 파운드리 2nm 공정과 GAA 격돌]]"]
    T_T_10["★ [[T1-04-첨단-패키징과-CoWoS의-병목|T1-04 첨단 패키징과 CoWoS의 병목]]"] <.-> S_T_14["[[T1-06-실리콘-포토닉스와-CPO의-상용화|T1-06 실리콘 포토닉스와 CPO의 상용화]]"]
```
