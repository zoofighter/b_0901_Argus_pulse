...
```mermaid
graph LR
    P_T_01["[[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]]"] --> T_T_12["★ [[T2-02-데이터센터-액체냉각의-표준화|T3-02 데이터센터 액체냉각의 표준화]]"]
    T_T_12["★ [[T2-02-데이터센터-액체냉각의-표준화|T3-02 데이터센터 액체냉각의 표준화]]"] --> D_T_05["[[T4-01-금리와-데이터센터|T4-01 금리와 데이터센터]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]] — 랙당 100kW+ 발열 폭증
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - [[T4-01-금리와-데이터센터|T4-01 금리와 데이터센터]] — 냉각 CAPEX 효율화로 PUE 1.1 달성
...
WHERE contains(thesis, "T3-02") OR contains(thesis, "T3-02") OR contains(file.outlinks, this.file.link)
