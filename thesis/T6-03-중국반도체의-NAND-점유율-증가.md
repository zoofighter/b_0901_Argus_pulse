...
```mermaid
flowchart TD
    P_Gov["🇨🇳 중국 정부 보조금 & 국산화 의무화"] --> T_Main["★ [[T6-03-중국반도체의-NAND-점유율-증가|T6-03 YMTC 낸드 점유율 급증]]"]
    P_Tech["🔬 Xtacking 하이브리드 본딩 기술"] --> T_Main
    
    T_Main -->|중국 내수 점유율 60% 잠식| D_Mem["[[T1-01-메모리-산업의-변화|T1-01 한국 레거시 낸드 매출 타격]]"]
    T_Main -->|글로벌 QLC 저가 공급 과잉| D_Peak["[[T1-13-메모리-2028년-피크아웃|T1-13 메모리 피크아웃 조기 촉발]]"]
    T_Main -->|차세대 400단 초격차 강제| D_400["[[T1-10-3D-DRAM-기술-전환과-400단-V-NAND|T1-10 400단 기술 격차 필요]]"]
```
