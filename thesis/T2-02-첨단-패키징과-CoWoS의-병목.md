...
```mermaid
graph LR
    P_T_01["[[T1-01-데이터센터의-변화|T1-01 데이터센터의 변화]]"] --> T_T_10["★ [[T2-02-첨단-패키징과-CoWoS의-병목|T2-02 첨단 패키징과 CoWoS의 병목]]"]
    P_T_02["[[T2-01-메모리-산업의-변화|T2-01 메모리 산업의 변화]]"] --> T_T_10["★ [[T2-02-첨단-패키징과-CoWoS의-병목|T2-02 첨단 패키징과 CoWoS의 병목]]"]
    T_T_10["★ [[T2-02-첨단-패키징과-CoWoS의-병목|T2-02 첨단 패키징과 CoWoS의 병목]]"] --> D_T_11["[[T2-03-유리기판의-차세대-패키징-침투|T2-03 유리기판의 차세대 패키징 침투]]"]
    T_T_10["★ [[T2-02-첨단-패키징과-CoWoS의-병목|T2-02 첨단 패키징과 CoWoS의 병목]]"] --> D_T_16["[[T2-04-파운드리-2nm-공정과-GAA-격돌|T2-04 파운드리 2nm 공정과 GAA 격돌]]"]
    T_T_10["★ [[T2-02-첨단-패키징과-CoWoS의-병목|T2-02 첨단 패키징과 CoWoS의 병목]]"] <.-> S_T_14["[[T3-01-실리콘-포토닉스와-CPO의-상용화|T3-01 실리콘 포토닉스와 CPO의 상용화]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T1-01-데이터센터의-변화|T1-01 데이터센터의 변화]] — AI 가속기 칩 패키징 대형화
  - [[T2-01-메모리-산업의-변화|T2-01 메모리 산업의 변화]] — HBM 적층 및 인터포저 결합
- ➡️ **동반 및 대체·경쟁 가설**:
  - [[T3-01-실리콘-포토닉스와-CPO의-상용화|T3-01 실리콘 포토닉스와 CPO의 상용화]] — 광학 인터커넥트 결합
- 🔽 **파생 및 후행 병목 가설**:
  - [[T2-03-유리기판의-차세대-패키징-침투|T2-03 유리기판의 차세대 패키징 침투]] — 기판 휨 한계 극복
  - [[T2-04-파운드리-2nm-공정과-GAA-격돌|T2-04 파운드리 2nm 공정과 GAA 격돌]] — 선단 파운드리-패키징 연계
