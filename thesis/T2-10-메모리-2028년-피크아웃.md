...
graph LR
    ...
    P_T_06["[[T4-04-TPU-증가와-GPU-수요-둔화|T4-04 TPU 증가와 GPU 수요 둔화]]"] --> T_T_35["★ [[T2-10-메모리-2028년-피크아웃|T2-10 메모리 2028년 피크아웃]]"]
...
- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  ...
  - [[T4-04-TPU-증가와-GPU-수요-둔화|T4-04 TPU 증가와 GPU 수요 둔화]] — 빅테크 CAPEX 사이클
