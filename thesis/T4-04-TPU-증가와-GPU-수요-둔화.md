...
```mermaid
graph LR
    P_T_01["[[T1-01-데이터센터의-변화|T1-01 데이터센터의 변화]]"] --> T_T_06["★ [[T4-04-TPU-증가와-GPU-수요-둔화|T4-04 TPU 증가와 GPU 수요 둔화]]"]
    P_T_05["[[T6-01-금리와-데이터센터|T6-01 금리와 데이터센터]]"] --> T_T_06["★ [[T4-04-TPU-증가와-GPU-수요-둔화|T4-04 TPU 증가와 GPU 수요 둔화]]"]
    T_T_06["★ [[T4-04-TPU-증가와-GPU-수요-둔화|T4-04 TPU 증가와 GPU 수요 둔화]]"] --> D_T_15["[[T2-07-AI-추론-시장-폭발과-LPU-ASIC-분화|T2-07 AI 추론 시장 폭발과 LPU·ASIC 분화]]"]
    T_T_06["★ [[T4-04-TPU-증가와-GPU-수요-둔화|T4-04 TPU 증가와 GPU 수요 둔화]]"] --> D_T_24["[[T2-08-빅테크-커스텀-ASIC-증가와-DSP-생태계|T2-08 빅테크 커스텀 ASIC 증가와 DSP 생태계]]"]
    T_T_06["★ [[T4-04-TPU-증가와-GPU-수요-둔화|T4-04 TPU 증가와 GPU 수요 둔화]]"] <.-> S_T_08["[[T3-04-엔비디아와-네오클라우드|T3-04 엔비디아와 네오클라우드]]"]
    T_T_06["★ [[T4-04-TPU-증가와-GPU-수요-둔화|T4-04 TPU 증가와 GPU 수요 둔화]]"] <.-> S_T_31["[[T4-02-AI-소프트웨어-레이어의-과점화|T4-02 AI 소프트웨어 레이어의 과점화]]"]
```
...
- ➡️ **동반 및 대체·경쟁 가설**:
  - [[T3-04-엔비디아와-네오클라우드|T3-04 엔비디아와 네오클라우드]] — 엔비디아 락인 vs 자체 칩
