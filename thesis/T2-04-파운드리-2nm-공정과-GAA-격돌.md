...
```mermaid
graph LR
    P_T_02["[[T2-01-메모리-산업의-변화|T2-01 메모리 산업의 변화]]"] --> T_T_16["★ [[T2-04-파운드리-2nm-공정과-GAA-격돌|T2-04 파운드리 2nm 공정과 GAA 격돌]]"]
    P_T_10["[[T2-02-첨단-패키징과-CoWoS의-병목|T2-02 첨단 패키징과 CoWoS의 병목]]"] --> T_T_16["★ [[T2-04-파운드리-2nm-공정과-GAA-격돌|T2-04 파운드리 2nm 공정과 GAA 격돌]]"]
    T_T_16["★ [[T2-04-파운드리-2nm-공정과-GAA-격돌|T2-04 파운드리 2nm 공정과 GAA 격돌]]"] --> D_T_24["[[T2-08-빅테크-커스텀-ASIC-증가와-DSP-생태계|T2-08 빅테크 커스텀 ASIC 증가와 DSP 생태계]]"]
```
