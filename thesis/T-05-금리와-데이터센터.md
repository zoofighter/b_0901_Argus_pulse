...
```mermaid
graph LR
    P_T_38["[[T-38-10년금리-5%-재진입-가능성|T-38 10년 금리 5% 재진입 가능성]]"] --> T_T_05["★ [[T-05-금리와-데이터센터|T-05 금리와 데이터센터]]"]
    T_T_05["★ [[T-05-금리와-데이터센터|T-05 금리와 데이터센터]]"] --> D_T_01["[[T-01-데이터센터의-변화|T-01 데이터센터의 변화]]"]
    T_T_05["★ [[T-05-금리와-데이터센터|T-05 금리와 데이터센터]]"] --> D_T_08["[[T-08-엔비디아와-네오클라우드|T-08 엔비디아와 네오클라우드]]"]
    T_T_05["★ [[T-05-금리와-데이터센터|T-05 금리와 데이터센터]]"] --> D_T_37["[[T-37-AI-버블-가능성|T-37 AI 버블 가능성]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T-38-10년금리-5%-재진입-가능성|T-38 10년 금리 5% 재진입 가능성]] — 매크로 고금리 장기화
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - [[T-01-데이터센터의-변화|T-01 데이터센터의 변화]] — CAPEX ROI 검증 압박
  - [[T-08-엔비디아와-네오클라우드|T-08 엔비디아와 네오클라우드]] — GPU 리스 부채 비용 급증
  - [[T-37-AI-버블-가능성|T-37 AI 버블 가능성]] — 수익화 지연 시 버블 붕괴
...
WHERE contains(thesis, "T-05") OR contains(file.outlinks, this.file.link)
