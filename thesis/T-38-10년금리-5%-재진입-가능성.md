...
```mermaid
graph LR
    T_T_38["★ [[T-38-10년금리-5%-재진입-가능성|T-38 10년 금리 5% 재진입 가능성]]"] --> D_T_05["[[T-05-금리와-데이터센터|T-05 금리와 데이터센터]]"]
    T_T_38["★ [[T-38-10년금리-5%-재진입-가능성|T-38 10년 금리 5% 재진입 가능성]]"] --> D_T_37["[[T-37-AI-버블-가능성|T-37 AI 버블 가능성]]"]
```
...
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - [[T-05-금리와-데이터센터|T-05 금리와 데이터센터]] — 빅테크 WACC 급등 및 CAPEX 위축
  - [[T-37-AI-버블-가능성|T-37 AI 버블 가능성]] — 밸류에이션 디레이팅 촉발
...
WHERE contains(thesis, "T-38") OR contains(file.outlinks, this.file.link)
