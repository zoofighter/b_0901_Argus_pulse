...
```mermaid
graph LR
    P_T_02["[[T2-01-메모리-산업의-변화|T2-01 메모리 산업의 변화]]"] --> T_T_28["★ [[T2-05-3D-DRAM-기술-전환과-400단-V-NAND|T2-05 3D DRAM 기술 전환과 400단 V-NAND]]"]
    P_T_07["[[T2-06-CXL-메모리의-확대|T2-06 CXL 메모리의 확대]]"] --> T_T_28["★ [[T2-05-3D-DRAM-기술-전환과-400단-V-NAND|T2-05 3D DRAM 기술 전환과 400단 V-NAND]]"]
```
