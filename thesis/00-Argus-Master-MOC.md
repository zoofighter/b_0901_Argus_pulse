...
flowchart TB
    subgraph Macro["🏛️ 매크로 자본시장 & 밸류에이션 (T4)"]
        T4_01["[[T6-01-금리와-데이터센터|T6-01 금리와 DC ROI]]"]
        T4_02["[[T3-04-엔비디아와-네오클라우드|T3-04 네오클라우드]]"]
        T4_03["[[T6-02-엔비디아와-GPU-금융|T6-02 GPU 금융]]"]
        T4_04["[[T6-03-AI-버블-가능성|T6-03 AI 버블 붕괴 리스크]]"]
        T4_05["[[T6-04-10년금리-5%-재진입-가능성|T6-04 10년 금리 5%]]"]
        T4_06["[[T6-05-오픈AI·앤트로픽의-5000억달러-매출-갭과-데이터센터-ROI-딜레마|T6-05 5000억$ 매출 갭]]"]
    end

    subgraph PowerInfra["⚡ AI 데이터센터 & 전력·냉각 인프라 (T2)"]
        T2_01["[[T1-01-데이터센터의-변화|T1-01 데이터센터 병목]]"]
        T2_02["[[T1-02-데이터센터-액체냉각의-표준화|T1-02 액체냉각 표준화]]"]
        T2_03["[[T1-03-SMR과-데이터센터-무탄소-전력-PPA|T1-03 SMR·무탄소 PPA]]"]
        T2_04["[[T1-04-AI-전력망용-대용량-ESS와-LFP-공급망|T1-04 대용량 ESS/LFP]]"]
        T2_05["[[T1-05-변압기-초고압-그리드-쇼티지-장기화|T1-05 변압기·그리드]]"]
        T2_06["[[T1-06-ESS와-한국배터리의-미국수혜|T1-06 K-배터리 미국수혜]]"]
        T2_07["[[T1-07-800V-48V-HVDC-전력-아키텍처-혁신|T1-07 800V/HVDC 혁신]]"]
        T2_08["[[T3-03-전력-포화와-분산형-AI-데이터센터-코로케이션|T3-03 분산형 코로케이션]]"]
        T2_09["[[T1-08-온사이트-가스터빈과-연료전지-자체발전|T1-08 온사이트 자체발전]]"]
    end

    subgraph ComputeMemory["💾 AI 컴퓨트 & 차세대 반도체 (T1)"]
        T1_01["[[T2-01-메모리-산업의-변화|T2-01 HBM4 ASIC화]]"]
        T1_02["[[T4-04-TPU-증가와-GPU-수요-둔화|T4-04 TPU vs GPU]]"]
        T1_03["[[T2-06-CXL-메모리의-확대|T2-06 CXL 메모리 풀링]]"]
        T1_04["[[T2-02-첨단-패키징과-CoWoS의-병목|T2-02 CoWoS 패키징]]"]
        T1_05["[[T2-03-유리기판의-차세대-패키징-침투|T2-03 유리기판 인터포저]]"]
        T1_06["[[T3-01-실리콘-포토닉스와-CPO의-상용화|T3-01 CPO 광반도체]]"]
        T1_07["[[T2-07-AI-추론-시장-폭발과-LPU-ASIC-분화|T2-07 추론 LPU·ASIC]]"]
        T1_08["[[T2-04-파운드리-2nm-공정과-GAA-격돌|T2-04 파운드리 2nm GAA]]"]
        T1_09["[[T2-08-빅테크-커스텀-ASIC-증가와-DSP-생태계|T2-08 빅테크 ASIC/DSP]]"]
        T1_10["[[T2-05-3D-DRAM-기술-전환과-400단-V-NAND|T2-05 3D DRAM & V-NAND]]"]
        T1_11["[[T3-02-초고속-AI-네트워킹-UEC-vs-인피니밴드|T3-02 UEC vs 인피니밴드]]"]
        T1_12["[[T2-09-반도체-소부장의-내재화|T2-09 반도체 소부장]]"]
        T1_13["[[T2-10-메모리-2028년-피크아웃|T2-10 2028 메모리 피크아웃]]"]
    end

    subgraph SoftwareAgents["💻 AI 엔터프라이즈 SW & 에이전트 (T5)"]
        T5_01["[[T4-01-오픈소스-모델-고도화와-온프레미스-사설-AI|T4-01 사설 AI / 온프레미스]]"]
        T5_02["[[T4-02-AI-소프트웨어-레이어의-과점화|T4-02 AI SW 레이어 과점]]"]
        T5_03["[[T4-03-바이오AI와-신약개발-가속|T4-03 바이오 AI 신약]]"]
    end

    subgraph Geopolitics["🌐 지정학, 소버린 AI & 공급망 안보 (T6)"]
        T6_01["[[T6-06-소버린-AI와-국가-단위-컴퓨트-인프라|T6-06 소버린 AI]]"]
        T6_02["[[T6-07-중국반도체의-HBM-생산가능성|T6-07 중국 HBM 추격]]"]
        T6_03["[[T6-08-중국반도체의-NAND-점유율-증가|T6-08 YMTC 낸드 점유율]]"]
    end

    subgraph EdgePhysical["🤖 피지컬 AI, 모빌리티 & 로보틱스 (T3)"]
        T3_01["[[T5-09-전고체-배터리의-변화|T5-09 전고체 배터리]]"]
        T3_02["[[T5-01-온디바이스-AI의-변화|T5-01 온디바이스 NPU]]"]
        T3_03["[[T5-06-휴머노이드-로봇과-액추에이터-공급망|T5-06 휴머노이드 로봇]]"]
        T3_04["[[T5-05-End-to-End-AI-자율주행과-로보택시|T5-05 E2E 자율주행]]"]
        T3_05["[[T5-07-피지컬-AI와-공간지능-반도체|T5-07 피지컬 AI 공간지능]]"]
        T3_06["[[T5-02-행동형-AI-에이전트와-모바일-교체-슈퍼사이클|T5-02 모바일 교체 사이클]]"]
        T3_07["[[T5-03-AI-PC-보급-확대와-Arm-기반-윈도우-생태계|T5-03 AI PC & Arm]]"]
        T3_08["[[T5-04-AI-스마트-글래스와-경량-AR-광학계|T5-04 AI 스마트 글래스]]"]
        T3_09["[[T5-08-피지컬AI와-로봇의-상용화|T5-08 로봇 상용화]]"]
    end
