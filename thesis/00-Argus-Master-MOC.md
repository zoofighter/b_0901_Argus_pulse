...
flowchart TB
    ...
    subgraph NetworkPlatform["🌐 초고속 네트워킹 & 시스템 플랫폼 (T3)"]
        ...
        T3_04["[[T3-04-800G·1.6T-광트랜시버와-AEC·LPO-초고속-인터커넥트-혁신|T3-04 800G/1.6T 광트랜시버·AEC]]"]
        ...
        T3_09["[[T3-09-PCIe-Gen6·Gen7-전환과-초고속-신호-리타이머-병목|T3-09 PCIe Gen6/7 리타이머]]"]
        T3_10["[[T3-10-NVLink-Switch-랙스케일-패브릭과-대규모-구리-백플레인|T3-10 NVLink 랙스케일 패브릭]]"]
    end
    ...
    subgraph SoftwareAgents["💻 AI 엔터프라이즈 SW & 파운데이션 모델 (T4)"]
        ...
        T4_08["[[T4-08-중국-AI-모델-급부상과-오픈AI·앤트로픽-과점-위협|T4-08 중국 AI 가격 파괴]]"]
        T4_09["[[T4-09-앤트로픽-클로드의-해석가능성-기술과-엔터프라이즈-AI-시장-독점|T4-09 Anthropic 해석가능성 독점]]"]
    end
...
| **Sector 3 (🌐 초고속 네트워킹·시스템 플랫폼)** | **[[03-초고속네트워킹-시스템플랫폼.canvas|🌐 Sector 3 캔버스]]** | 800G/1.6T 광트랜시버, AEC/LPO, PCIe 리타이머, NVLink 패브릭, CPO, UEC vs IB, Coherent, Astera Labs, Amphenol |
| **Sector 4 (💻 파운데이션 모델·엔터프라이즈 SW)** | **[[04-파운데이션모델-엔터프라이즈SW.canvas|💻 Sector 4 캔버스]]** | 앤트로픽 해석가능성/Claude, GPT-6 아스트라, xAI Grok, DeepSeek/Qwen, o1/o3, OpenAI, Anthropic |
| **Sector 5 (🤖 피지컬 AI·자율주행·로보틱스)** | **[[05-피지컬AI-자율주행-로보틱스.canvas|🤖 Sector 5 캔버스]]** | E2E 자율주행, 휴머노이드 액추에이터, 온디바이스 NPU, 공간지능, Tesla, Apple |
| **Sector 6 (🏛️ 매크로 자본시장·밸류·지정학)** | **[[06-매크로-밸류에이션-지정학안보.canvas|🏛️ Sector 6 캔버스]]** | $500B 매출 갭, GPU 금융, AI 버블, 소버린 AI, 중국 반도체, 네오클라우드 |
...
### 3. 🌐 초고속 네트워킹 & 시스템 플랫폼 (Sector 3: T3, 10개)
| ID | 가설 제목 | 스택 | 성격 | 핵심 기업 | 주요 연관 테제 |
|:---|:---|:---:|:---:|:---|:---|
...
| **[[T3-04-800G·1.6T-광트랜시버와-AEC·LPO-초고속-인터커넥트-혁신|T3-04]]** | 800G·1.6T 광트랜시버와 AEC·LPO 인터커넥트 | `L3` | `🚀 주류` | `[[Company-Innolight|Innolight]]`, `[[Company-Coherent|Coherent]]` | `[[T3-02-초고속-AI-네트워킹-UEC-vs-인피니밴드|T3-02]]`, `[[T3-10-NVLink-Switch-랙스케일-패브릭과-대규모-구리-백플레인|T3-10]]` |
...
| **[[T3-07-데이터센터-간-초장거리-인터커넥트-DCI|T3-07]]** | 데이터센터 간 초장거리 인터커넥트 DCI | `L3` | `🚀 주류` | `[[Company-Coherent|Coherent]]`, `[[Company-Lumentum|Lumentum]]` | `[[T3-01-실리콘-포토닉스와-CPO의-상용화|T3-01]]`, `[[T3-03-전력-포화와-분산형-AI-데이터센터-코로케이션|T3-03]]` |
| **[[T3-08-AI-클러스터-OS와-MFU-가동률-최적화-SW|T3-08]]** | AI 클러스터 OS와 MFU 가동률 최적화 SW | `L3` | `🚀 주류` | `[[Company-NVIDIA|NVIDIA]]`, `CoreWeave`, `Anyscale` | `[[T6-05-오픈AI·앤트로픽의-5000억달러-매출-갭과-데이터센터-ROI-딜레마|T6-05]]` |
| **[[T3-09-PCIe-Gen6·Gen7-전환과-초고속-신호-리타이머-병목|T3-09]]** | PCIe Gen6·Gen7 전환과 초고속 신호 리타이머 병목 | `L3` | `🚀 주류` | `[[Company-Astera Labs|Astera Labs]]`, `[[Company-Montage|Montage]]` | `[[T3-06-초고다층-기판-MLB와-초저손실-CCL-병목|T3-06]]`, `[[T3-10-NVLink-Switch-랙스케일-패브릭과-대규모-구리-백플레인|T3-10]]` |
| **[[T3-10-NVLink-Switch-랙스케일-패브릭과-대규모-구리-백플레인|T3-10]]** | NVLink Switch 랙스케일 패브릭과 대규모 구리 백플레인 | `L3` | `🚀 주류` | `[[Company-NVIDIA|NVIDIA]]`, `[[Company-Amphenol|Amphenol]]` | `[[T1-02-데이터센터-액체냉각의-표준화|T1-02]]`, `[[T3-04-800G·1.6T-광트랜시버와-AEC·LPO-초고속-인터커넥트-혁신|T3-04]]` |

### 4. 💻 AI 엔터프라이즈 SW & 파운데이션 모델 (Sector 4: T4, 9개)
| ID | 가설 제목 | 스택 | 성격 | 핵심 기업 | 주요 연관 테제 |
|:---|:---|:---:|:---:|:---|:---|
...
| **[[T4-09-앤트로픽-클로드의-해석가능성-기술과-엔터프라이즈-AI-시장-독점|T4-09]]** | 앤트로픽 클로드의 해석가능성 기술과 엔터프라이즈 AI 독점 | `L4` | `🚀 주류` | `[[Company-Anthropic|Anthropic]]`, `[[Company-Amazon|Amazon]]` | `[[T4-04-자율형-에이전트와-컴퓨터-제어-엔터프라이즈-침투|T4-04]]`, `[[T6-05-오픈AI·앤트로픽의-5000억달러-매출-갭과-데이터센터-ROI-딜레마|T6-05]]` |
...
| **[[T6-03-AI-버블-가능성|T6-03]]** | AI 버블 가능성 (CAPEX ROI 불일치) | `L3` | `🛡️ 헷지` | `[[Company-NVIDIA|NVIDIA]]`, `[[Company-BigTech|빅테크]]` | `[[T6-01-금리와-데이터센터|T6-01]]`, `[[T6-09-엔비디아와-네오클라우드|T6-09]]`, `[[T4-09-앤트로픽-클로드의-해석가능성-기술과-엔터프라이즈-AI-시장-독점|T4-09]]` |
...
| **[[T6-05-오픈AI·앤트로픽의-5000억달러-매출-갭과-데이터센터-ROI-딜레마|T6-05]]** | 오픈AI·앤트로픽의 5000억$ 매출 갭 | `L3` | `🛡️ 헷지` | `[[Company-OpenAI|OpenAI]]`, `[[Company-Anthropic|Anthropic]]` | `[[T6-03-AI-버블-가능성|T6-03]]`, `[[T4-09-앤트로픽-클로드의-해석가능성-기술과-엔터프라이즈-AI-시장-독점|T4-09]]`, `[[T2-11-TPU-증가와-GPU-수요-둔화|T2-11]]` |
