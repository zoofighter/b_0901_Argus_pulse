...
flowchart TB
    subgraph Macro["🏛️ 매크로 자본시장 & 밸류에이션 (T4)"]
        ...
        T4_06["[[T4-06-오픈AI·앤트로픽의-5000억달러-매출-갭과-데이터센터-ROI-딜레마|T4-06 5000억$ 매출 갭]]"]
    end
    ...
    subgraph Geopolitics["🌐 지정학, 소버린 AI & 공급망 안보 (T6)"]
        ...
        T6_03["[[T6-03-중국반도체의-NAND-점유율-증가|T6-03 YMTC 낸드 점유율]]"]
    end
...
| **[[T4-06-오픈AI·앤트로픽의-5000억달러-매출-갭과-데이터센터-ROI-딜레마|T4-06]]** | 오픈AI·앤트로픽의 5000억$ 매출 갭 | `L3` | `🛡️ 헷지` | `[[Company-OpenAI\|OpenAI]]`, `[[Company-Anthropic\|Anthropic]]` | `[[T4-04-AI-버블-가능성|T4-04]]`, `[[T5-02-AI-소프트웨어-레이어의-과점화|T5-02]]`, `[[T1-02-TPU-증가와-GPU-수요-둔화|T1-02]]` |
...
| **[[T6-03-중국반도체의-NAND-점유율-증가|T6-03]]** | 중국 반도체의 NAND 점유율 증가 | `L1` | `🛡️ 헷지` | `[[Company-YMTC\|YMTC]]`, `[[Company-삼성전자\|삼성전자]]` | `[[T1-01-메모리-산업의-변화|T1-01]]`, `[[T1-13-메모리-2028년-피크아웃|T1-13]]` |
