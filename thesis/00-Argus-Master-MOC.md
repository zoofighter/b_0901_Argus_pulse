...
> **Argus Nexus 중앙 사령탑**  
> AI 및 첨단 기술 산업의 구조적 변화를 추적하는 **총 43개 투자 가설(Theses)**의 상호 인과관계 맵과 **6대 섹터 & 5대 교차 차원(다차원 대시보드)** 사령탑입니다.  
...
flowchart TB
    ...
    subgraph ComputeMemory["💾 AI 컴퓨트 & 차세대 반도체 (T2)"]
        T2_01["[[T2-01-메모리-산업의-변화|T2-01 HBM4 ASIC화]]"]
        T2_02["[[T2-02-첨단-패키징과-CoWoS의-병목|T2-02 CoWoS 패키징]]"]
        T2_03["[[T2-03-유리기판의-차세대-패키징-침투|T2-03 유리기판 인터포저]]"]
        T2_04["[[T2-04-파운드리-2nm-공정과-GAA-격돌|T2-04 파운드리 2nm GAA]]"]
        T2_05["[[T2-05-3D-DRAM-기술-전환과-400단-V-NAND|T2-05 3D DRAM & V-NAND]]"]
    ...
    subgraph SoftwareAgents["💻 AI 엔터프라이즈 SW & 파운데이션 모델 (T4)"]
        ...
        T4_03["[[T4-03-바이오AI와-신약개발-가속|T4-03 바이오 AI 신약]]"]
        T4_04["[[T4-04-TPU-증가와-GPU-수요-둔화|T4-04 TPU vs GPU]]"]
    end
...
> 41개 정식 테제 밖에서 새롭게 감지되어 검증·보육 중인 **차세대 후보 가설(`TC-XX`)** 목록입니다.
...
| **[[T4-04-TPU-증가와-GPU-수요-둔화|T4-04]]** | TPU 증가와 GPU 수요 둔화 | `L1` | `🛡️ 헷지` | `[[Company-Alphabet|Alphabet]]`, `[[Company-Broadcom|Broadcom]]` | `[[T3-04-엔비디아와-네오클라우드|T3-04]]`, `[[T2-07-AI-추론-시장-폭발과-LPU-ASIC-분화|T2-07]]`, `[[T2-08-빅테크-커스텀-ASIC-증가와-DSP-생태계|T2-08]]` |
...
| **[[T2-07-AI-추론-시장-폭발과-LPU-ASIC-분화|T2-07]]** | AI 추론 시장 폭발과 LPU·ASIC | `L1` | `🚀 주류` | `[[Company-Groq|Groq]]`, `[[Company-Qualcomm|Qualcomm]]` | `[[T4-04-TPU-증가와-GPU-수요-둔화|T4-04]]`, `[[T2-08-빅테크-커스텀-ASIC-증가와-DSP-생태계|T2-08]]` |
...
| **[[T2-08-빅테크-커스텀-ASIC-증가와-DSP-생태계|T2-08]]** | 빅테크 커스텀 ASIC 증가와 DSP | `L1` | `🚀 주류` | `[[Company-Broadcom|Broadcom]]`, `[[Company-TSMC|TSMC]]` | `[[T4-04-TPU-증가와-GPU-수요-둔화|T4-04]]`, `[[T2-07-AI-추론-시장-폭발과-LPU-ASIC-분화|T2-07]]` |
...
| **[[T2-10-메모리-2028년-피크아웃|T2-10]]** | 메모리 2028년 피크아웃 논쟁 | `L1` | `🛡️ 헷지` | `[[Company-SK하이닉스|SK하이닉스]]`, `[[Company-삼성전자|삼성전자]]` | `[[T2-01-메모리-산업의-변화|T2-01]]`, `[[T4-04-TPU-증가와-GPU-수요-둔화|T4-04]]` |
...
### 4. 🏛️ 매크로 자본시장, 금리 & 밸류에이션 (T4, 6개)
| ID | 가설 제목 | 스택 | 성격 | 핵심 기업 | 주요 연관 테제 |
|:---|:---|:---:|:---:|:---|:---|
| **[[T6-01-금리와-데이터센터|T6-01]]** | 금리와 데이터센터 (CAPEX ROI) | `L3` | `🛡️ 헷지` | `[[Company-Microsoft|Microsoft]]`, `[[Company-Amazon|Amazon]]` | `[[T1-01-데이터센터의-변화|T1-01]]`, `[[T3-04-엔비디아와-네오클라우드|T3-04]]`, `[[T6-03-AI-버블-가능성|T6-03]]` |
| **[[T3-04-엔비디아와-네오클라우드|T3-04]]** | 엔비디아와 네오클라우드 | `L3` | `🚀 주류` | `[[Company-CoreWeave|CoreWeave]]`, `[[Company-NVIDIA|NVIDIA]]` | `[[T1-01-데이터센터의-변화|T1-01]]`, `[[T6-01-금리와-데이터센터|T6-01]]`, `[[T6-02-엔비디아와-GPU-금융|T6-02]]` |
| **[[T6-02-엔비디아와-GPU-금융|T6-02]]** | 엔비디아와 GPU 금융 | `L3` | `🛡️ 헷지` | `[[Company-Blackstone|Blackstone]]`, `[[Company-CoreWeave|CoreWeave]]` | `[[T3-04-엔비디아와-네오클라우드|T3-04]]`, `[[T6-03-AI-버블-가능성|T6-03]]` |
| **[[T6-03-AI-버블-가능성|T6-03]]** | AI 버블 가능성 (CAPEX ROI 불일치) | `L3` | `🛡️ 헷지` | `[[Company-NVIDIA|NVIDIA]]`, `[[Company-BigTech|빅테크]]` | `[[T6-01-금리와-데이터센터|T6-01]]`, `[[T3-04-엔비디아와-네오클라우드|T3-04]]`, `[[T6-02-엔비디아와-GPU-금융|T6-02]]` |
...
| **[[T6-05-오픈AI·앤트로픽의-5000억달러-매출-갭과-데이터센터-ROI-딜레마|T6-05]]** | 오픈AI·앤트로픽의 5000억$ 매출 갭 | `L3` | `🛡️ 헷지` | `[[Company-OpenAI|OpenAI]]`, `[[Company-Anthropic|Anthropic]]` | `[[T6-03-AI-버블-가능성|T6-03]]`, `[[T4-02-AI-소프트웨어-레이어의-과점화|T4-02]]`, `[[T4-04-TPU-증가와-GPU-수요-둔화|T4-04]]` |
...
| **[[T4-02-AI-소프트웨어-레이어의-과점화|T4-02]]** | AI 소프트웨어 레이어의 과점화 | `L4` | `🚀 주류` | `[[Company-Microsoft|Microsoft]]`, `[[Company-Alphabet|Alphabet]]` | `[[T4-04-TPU-증가와-GPU-수요-둔화|T4-04]]`, `[[T3-04-엔비디아와-네오클라우드|T3-04]]` |
| **[[T4-03-바이오AI와-신약개발-가속|T4-03]]** | 바이오 AI와 신약 개발 가속 | `L4` | `🚀 주류` | `[[Company-Recursion|Recursion]]`, `[[Company-Schrodinger|Schrodinger]]` | `[[T5-01-온디바이스-AI의-변화|T5-01]]`, `[[T2-07-AI-추론-시장-폭발과-LPU-ASIC-분화|T2-07]]` |

### 6. 🌐 지정학, 소버린 AI & 공급망 안보 (T6, 3개)
| ID | 가설 제목 | 스택 | 성격 | 핵심 기업 | 주요 연관 테제 |
|:---|:---|:---:|:---:|:---|:---|
