...
```mermaid
graph LR
    P_T_04["[[T3-02-온디바이스-AI의-변화|T3-02 온디바이스 AI의 변화]]"] --> T_T_27["★ [[T3-08-AI-스마트-글래스와-경량-AR-광학계|T3-08 AI 스마트 글래스와 경량 AR 광학계]]"]
    P_T_19["[[T3-05-피지컬-AI와-공간지능-반도체|T3-05 피지컬 AI와 공간지능 반도체]]"] --> T_T_27["★ [[T3-08-AI-스마트-글래스와-경량-AR-광학계|T3-08 AI 스마트 글래스와 경량 AR 광학계]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T3-02-온디바이스-AI의-변화|T3-02 온디바이스 AI의 변화]] — 초저전력 엣지 NPU
  - [[T3-05-피지컬-AI와-공간지능-반도체|T3-05 피지컬 AI와 공간지능 반도체]] — 공간 인식 광학계
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - (해당 없음)
