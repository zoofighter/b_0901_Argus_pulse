...
```mermaid
graph LR
    P_T_08["[[T4-02-엔비디아와-네오클라우드|T4-02 엔비디아와 네오클라우드]]"] --> T_T_09["★ [[T4-03-엔비디아와-GPU-금융|T4-03 엔비디아와 GPU 금융]]"]
    T_T_09["★ [[T4-03-엔비디아와-GPU-금융|T4-03 엔비디아와 GPU 금융]]"] --> D_T_37["[[T4-04-AI-버블-가능성|T4-04 AI 버블 가능성]]"]
    T_T_09["★ [[T4-03-엔비디아와-GPU-금융|T4-03 엔비디아와 GPU 금융]]"] --> D_T_05["[[T4-01-금리와-데이터센터|T4-01 금리와 데이터센터]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T4-02-엔비디아와-네오클라우드|T4-02 엔비디아와 네오클라우드]] — GPU 자산화 및 금융 결합
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - [[T4-04-AI-버블-가능성|T4-04 AI 버블 가능성]] — GPU 감가상각 및 담보 가치 하락
  - [[T4-01-금리와-데이터센터|T4-01 금리와 데이터센터]] — 부채 조달 한계
