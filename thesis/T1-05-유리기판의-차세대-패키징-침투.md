...
```mermaid
graph LR
    P_T_10["[[T1-04-첨단-패키징과-CoWoS의-병목|T1-04 첨단 패키징과 CoWoS의 병목]]"] --> T_T_11["★ [[T1-05-유리기판의-차세대-패키징-침투|T1-05 유리기판의 차세대 패키징 침투]]"]
    T_T_11["★ [[T1-05-유리기판의-차세대-패키징-침투|T1-05 유리기판의 차세대 패키징 침투]]"] --> D_T_02["[[T1-01-메모리-산업의-변화|T1-01 메모리 산업의 변화]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T1-04-첨단-패키징과-CoWoS의-병목|T1-04 첨단 패키징과 CoWoS의 병목]] — 실리콘/유기 기판 대면적화 한계
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - [[T1-01-메모리-산업의-변화|T1-01 메모리 산업의 변화]] — HBM4/5 초고단수 패키징 안정화
