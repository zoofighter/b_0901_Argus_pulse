...
related_theses:
  - "[[T2-08-전력-포화와-분산형-AI-데이터센터-코로케이션|T2-08]]"
...
## 📌 핵심 투자 포인트 & 연관 테제
- **분산형 AI 코로케이션**: **[[T2-08-전력-포화와-분산형-AI-데이터센터-코로케이션|T2-08]]** (전력 포화에 따른 임대 가치 상승)
- **데이터센터 물리 인프라**: **[[T2-01-데이터센터의-변화|T2-01]]** (액체냉각 레트로핏 및 고밀도 랙 전환)
- **자본비용과 ROI**: **[[T4-01-금리와-데이터센터|T4-01]]** (금리 안정화 시 리츠 밸류에이션 리레이팅)
