...
```mermaid
graph LR
    P_T_01["[[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]]"] --> T_T_13["★ [[T2-03-SMR과-데이터센터-무탄소-전력-PPA|T3-03 SMR과 데이터센터 무탄소 전력 PPA]]"]
    T_T_13["★ [[T2-03-SMR과-데이터센터-무탄소-전력-PPA|T3-03 SMR과 데이터센터 무탄소 전력 PPA]]"] --> D_T_22["[[T2-04-AI-전력망용-대용량-ESS와-LFP-공급망|T3-04 AI 전력망용 대용량 ESS와 LFP 공급망]]"]
    T_T_13["★ [[T2-03-SMR과-데이터센터-무탄소-전력-PPA|T3-03 SMR과 데이터센터 무탄소 전력 PPA]]"] <.-> S_T_23["[[T2-05-변압기-초고압-그리드-쇼티지-장기화|T3-05 변압기·초고압 그리드 쇼티지 장기화]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]] — 기저부하 무탄소 전력 수요
- ➡️ **동반 및 대체·경쟁 가설**:
  - [[T2-05-변압기-초고압-그리드-쇼티지-장기화|T3-05 변압기·초고압 그리드 쇼티지 장기화]] — 그리드 접속 지연 대안
- 🔽 **파생 및 후행 병목 가설**:
  - [[T2-04-AI-전력망용-대용량-ESS와-LFP-공급망|T3-04 AI 전력망용 대용량 ESS와 LFP 공급망]] — 원전-ESS 하이브리드 PPA
