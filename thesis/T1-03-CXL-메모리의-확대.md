...
```mermaid
graph LR
    P_T_01["[[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]]"] --> T_T_07["★ [[T1-03-CXL-메모리의-확대|T1-03 CXL 메모리의 확대]]"]
    P_T_02["[[T1-01-메모리-산업의-변화|T1-01 메모리 산업의 변화]]"] --> T_T_07["★ [[T1-03-CXL-메모리의-확대|T1-03 CXL 메모리의 확대]]"]
    T_T_07["★ [[T1-03-CXL-메모리의-확대|T1-03 CXL 메모리의 확대]]"] --> D_T_28["[[T1-10-3D-DRAM-기술-전환과-400단-V-NAND|T1-10 3D DRAM 기술 전환과 400단 V-NAND]]"]
    T_T_07["★ [[T1-03-CXL-메모리의-확대|T1-03 CXL 메모리의 확대]]"] <.-> S_T_02["[[T1-01-메모리-산업의-변화|T1-01 메모리 산업의 변화]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]] — 서버 메모리 용량 병목
  - [[T1-01-메모리-산업의-변화|T1-01 메모리 산업의 변화]] — HBM 고가격 보완 필요
- ➡️ **동반 및 대체·경쟁 가설**:
  - [[T1-01-메모리-산업의-변화|T1-01 메모리 산업의 변화]] — HBM vs CXL 보완 관계
- 🔽 **파생 및 후행 병목 가설**:
  - [[T1-10-3D-DRAM-기술-전환과-400단-V-NAND|T1-10 3D DRAM 기술 전환과 400단 V-NAND]] — DRAM 풀링 아키텍처
