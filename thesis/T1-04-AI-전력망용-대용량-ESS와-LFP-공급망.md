...
```mermaid
graph LR
    P_T_01["[[T1-01-데이터센터의-변화|T1-01 데이터센터의 변화]]"] --> T_T_22["★ [[T1-04-AI-전력망용-대용량-ESS와-LFP-공급망|T1-04 AI 전력망용 대용량 ESS와 LFP 공급망]]"]
    T_T_22["★ [[T1-04-AI-전력망용-대용량-ESS와-LFP-공급망|T1-04 AI 전력망용 대용량 ESS와 LFP 공급망]]"] --> D_T_32["[[T1-06-ESS와-한국배터리의-미국수혜|T1-06 ESS와 한국 배터리의 미국 수혜]]"]
    T_T_22["★ [[T1-04-AI-전력망용-대용량-ESS와-LFP-공급망|T1-04 AI 전력망용 대용량 ESS와 LFP 공급망]]"] <.-> S_T_23["[[T1-05-변압기-초고압-그리드-쇼티지-장기화|T1-05 변압기·초고압 그리드 쇼티지 장기화]]"]
```
