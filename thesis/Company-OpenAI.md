...
created: 2026-09-06
related_theses:
  - "[[T4-06-오픈AI·앤트로픽의-5000억달러-매출-갭과-데이터센터-ROI-딜레마|T4-06]]"
...
- **$5,000억 매출 갭과 ROI 딜레마**: **[[T4-06-오픈AI·앤트로픽의-5000억달러-매출-갭과-데이터센터-ROI-딜레마|T4-06]]** (AI 데이터센터 인프라 소화를 위한 매출 허들 검증)
- **AI 소프트웨어 과점화**: **[[T5-02-AI-소프트웨어-레이어의-과점화|T5-02]]** (기업용 LLM API 과점을 통한 레거시 SaaS 시장 잠식)
- **AI 인프라 버블 및 CapEx 과잉 리스크**: **[[T4-04-AI-버블-가능성|T4-04]]** (수익화 지연 시 빅테크 인프라 투자 조정)
