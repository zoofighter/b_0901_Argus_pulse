...
```mermaid
graph LR
    P_T_06["[[T1-02-TPU-증가와-GPU-수요-둔화|T1-02 TPU 증가와 GPU 수요 둔화]]"] --> T_T_24["★ [[T1-09-빅테크-커스텀-ASIC-증가와-DSP-생태계|T1-09 빅테크 커스텀 ASIC 증가와 DSP 생태계]]"]
    P_T_15["[[T1-07-AI-추론-시장-폭발과-LPU-ASIC-분화|T1-07 AI 추론 시장 폭발과 LPU·ASIC 분화]]"] --> T_T_24["★ [[T1-09-빅테크-커스텀-ASIC-증가와-DSP-생태계|T1-09 빅테크 커스텀 ASIC 증가와 DSP 생태계]]"]
    T_T_24["★ [[T1-09-빅테크-커스텀-ASIC-증가와-DSP-생태계|T1-09 빅테크 커스텀 ASIC 증가와 DSP 생태계]]"] --> D_T_16["[[T1-08-파운드리-2nm-공정과-GAA-격돌|T1-08 파운드리 2nm 공정과 GAA 격돌]]"]
```
