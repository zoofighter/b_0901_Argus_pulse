...
aliases:
- T1-10
- T1-10 3D DRAM 기술 전환과 400단 V-NAND
- T-28
...
```mermaid
graph LR
    P_T_02["[[T1-01-메모리-산업의-변화|T1-01 메모리 산업의 변화]]"] --> T_T_28["★ [[T1-10-3D-DRAM-기술-전환과-400단-V-NAND|T1-10 3D DRAM 기술 전환과 400단 V-NAND]]"]
    P_T_07["[[T1-03-CXL-메모리의-확대|T1-03 CXL 메모리의 확대]]"] --> T_T_28["★ [[T1-10-3D-DRAM-기술-전환과-400단-V-NAND|T1-10 3D DRAM 기술 전환과 400단 V-NAND]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T1-01-메모리-산업의-변화|T1-01 메모리 산업의 변화]] — 1c/1d nm D램 미세화 한계
  - [[T1-03-CXL-메모리의-확대|T1-03 CXL 메모리의 확대]] — 초고용량 메모리 적층 요구
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - (해당 없음)
