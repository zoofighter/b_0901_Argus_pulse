...
```mermaid
graph LR
    P_T_04["[[T3-02-온디바이스-AI의-변화|T3-02 온디바이스 AI의 변화]]"] --> T_T_21["★ [[T3-07-AI-PC-보급-확대와-Arm-기반-윈도우-생태계|T3-07 AI PC 보급 확대와 Arm 기반 윈도우 생태계]]"]
    T_T_21["★ [[T3-07-AI-PC-보급-확대와-Arm-기반-윈도우-생태계|T3-07 AI PC 보급 확대와 Arm 기반 윈도우 생태계]]"] <.-> S_T_20["[[T3-06-행동형-AI-에이전트와-모바일-교체-슈퍼사이클|T3-06 행동형 AI 에이전트와 모바일 교체 슈퍼사이클]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T3-02-온디바이스-AI의-변화|T3-02 온디바이스 AI의 변화]] — 40+ TOPS NPU 표준화
- ➡️ **동반 및 대체·경쟁 가설**:
  - [[T3-06-행동형-AI-에이전트와-모바일-교체-슈퍼사이클|T3-06 행동형 AI 에이전트와 모바일 교체 슈퍼사이클]] — 디바이스 생태계 연계
- 🔽 **파생 및 후행 병목 가설**:
  - (해당 없음)
