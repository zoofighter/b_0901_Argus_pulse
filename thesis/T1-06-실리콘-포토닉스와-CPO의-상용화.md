...
```mermaid
graph LR
    P_T_01["[[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]]"] --> T_T_14["★ [[T1-06-실리콘-포토닉스와-CPO의-상용화|T1-06 실리콘 포토닉스와 CPO의 상용화]]"]
    P_T_10["[[T1-04-첨단-패키징과-CoWoS의-병목|T1-04 첨단 패키징과 CoWoS의 병목]]"] --> T_T_14["★ [[T1-06-실리콘-포토닉스와-CPO의-상용화|T1-06 실리콘 포토닉스와 CPO의 상용화]]"]
    T_T_14["★ [[T1-06-실리콘-포토닉스와-CPO의-상용화|T1-06 실리콘 포토닉스와 CPO의 상용화]]"] --> D_T_29["[[T1-11-초고속-AI-네트워킹-UEC-vs-인피니밴드|T1-11 초고속 AI 네트워킹 UEC vs 인피니밴드]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]] — 데이터센터 내 구리 배선 대역폭 한계
  - [[T1-04-첨단-패키징과-CoWoS의-병목|T1-04 첨단 패키징과 CoWoS의 병목]] — CPO 패키징 통합
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - [[T1-11-초고속-AI-네트워킹-UEC-vs-인피니밴드|T1-11 초고속 AI 네트워킹 UEC vs 인피니밴드]] — 광 스위칭 네트워크
