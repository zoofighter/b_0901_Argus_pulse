...
```mermaid
graph LR
    P_T_01["[[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]]"] --> T_T_29["★ [[T1-11-초고속-AI-네트워킹-UEC-vs-인피니밴드|T1-11 초고속 AI 네트워킹 UEC vs 인피니밴드]]"]
    P_T_14["[[T1-06-실리콘-포토닉스와-CPO의-상용화|T1-06 실리콘 포토닉스와 CPO의 상용화]]"] --> T_T_29["★ [[T1-11-초고속-AI-네트워킹-UEC-vs-인피니밴드|T1-11 초고속 AI 네트워킹 UEC vs 인피니밴드]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]] — 클러스터 스케일아웃 네트워크 병목
  - [[T1-06-실리콘-포토닉스와-CPO의-상용화|T1-06 실리콘 포토닉스와 CPO의 상용화]] — 광 인터커넥트 도입
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - (해당 없음)
