...
aliases:
- T6-06
- T6-06 소버린 AI와 국가 단위 컴퓨트 인프라
- T-26
- T-26 소버린 AI와 국가 단위 컴퓨트 인프라
- 소버린 AI와 국가 단위 컴퓨트 인프라
...
```mermaid
graph LR
    P_T_01["[[T1-01-데이터센터의-변화|T1-01 데이터센터의 변화]]"] --> T_T_26["★ [[T6-06-소버린-AI와-국가-단위-컴퓨트-인프라|T6-06 소버린 AI와 국가 단위 컴퓨트 인프라]]"]
    T_T_26["★ [[T6-06-소버린-AI와-국가-단위-컴퓨트-인프라|T6-06 소버린 AI와 국가 단위 컴퓨트 인프라]]"] <.-> S_T_25["[[T4-01-오픈소스-모델-고도화와-온프레미스-사설-AI|T4-01 오픈소스 모델 고도화와 온프레미스 사설 AI]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T1-01-데이터센터의-변화|T1-01 데이터센터의 변화]] — 글로벌 컴퓨트 인프라 주권 경쟁
- ➡️ **동반 및 대체·경쟁 가설**:
  - [[T4-01-오픈소스-모델-고도화와-온프레미스-사설-AI|T4-01 오픈소스 모델 고도화와 온프레미스 사설 AI]] — 자체 LLM 배포
- 🔽 **파생 및 후행 병목 가설**:
  - (해당 없음)
...
WHERE contains(thesis, "T6-01") OR contains(thesis, "T6-01") OR contains(file.outlinks, this.file.link)
