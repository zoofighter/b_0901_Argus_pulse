...
```mermaid
graph LR
    P_T_03["[[T5-09-전고체-배터리의-변화|T5-09 전고체 배터리의 변화]]"] --> T_T_32["★ [[T1-06-ESS와-한국배터리의-미국수혜|T1-06 ESS와 한국 배터리의 미국 수혜]]"]
    P_T_22["[[T1-04-AI-전력망용-대용량-ESS와-LFP-공급망|T1-04 AI 전력망용 대용량 ESS와 LFP 공급망]]"] --> T_T_32["★ [[T1-06-ESS와-한국배터리의-미국수혜|T1-06 ESS와 한국 배터리의 미국 수혜]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T5-09-전고체-배터리의-변화|T5-09 전고체 배터리의 변화]] — 중장기 로드맵
  - [[T1-04-AI-전력망용-대용량-ESS와-LFP-공급망|T1-04 AI 전력망용 대용량 ESS와 LFP 공급망]] — 북미 ESS 시장 폭발
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - (해당 없음)
