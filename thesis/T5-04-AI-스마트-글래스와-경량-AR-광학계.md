...
```mermaid
graph LR
    P_T_04["[[T5-01-온디바이스-AI의-변화|T5-01 온디바이스 AI의 변화]]"] --> T_T_27["★ [[T5-04-AI-스마트-글래스와-경량-AR-광학계|T5-04 AI 스마트 글래스와 경량 AR 광학계]]"]
    P_T_19["[[T5-07-피지컬-AI와-공간지능-반도체|T5-07 피지컬 AI와 공간지능 반도체]]"] --> T_T_27["★ [[T5-04-AI-스마트-글래스와-경량-AR-광학계|T5-04 AI 스마트 글래스와 경량 AR 광학계]]"]
```
