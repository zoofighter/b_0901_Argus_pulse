...
```mermaid
graph LR
    P_T_01["[[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]]"] --> T_T_06["★ [[T1-02-TPU-증가와-GPU-수요-둔화|T1-02 TPU 증가와 GPU 수요 둔화]]"]
    P_T_05["[[T4-01-금리와-데이터센터|T4-01 금리와 데이터센터]]"] --> T_T_06["★ [[T1-02-TPU-증가와-GPU-수요-둔화|T1-02 TPU 증가와 GPU 수요 둔화]]"]
    T_T_06["★ [[T1-02-TPU-증가와-GPU-수요-둔화|T1-02 TPU 증가와 GPU 수요 둔화]]"] --> D_T_15["[[T1-07-AI-추론-시장-폭발과-LPU-ASIC-분화|T1-07 AI 추론 시장 폭발과 LPU·ASIC 분화]]"]
    T_T_06["★ [[T1-02-TPU-증가와-GPU-수요-둔화|T1-02 TPU 증가와 GPU 수요 둔화]]"] --> D_T_24["[[T1-09-빅테크-커스텀-ASIC-증가와-DSP-생태계|T1-09 빅테크 커스텀 ASIC 증가와 DSP 생태계]]"]
    T_T_06["★ [[T1-02-TPU-증가와-GPU-수요-둔화|T1-02 TPU 증가와 GPU 수요 둔화]]"] <.-> S_T_08["[[T4-02-엔비디아와-네오클라우드|T4-02 엔비디아와 네오클라우드]]"]
    T_T_06["★ [[T1-02-TPU-증가와-GPU-수요-둔화|T1-02 TPU 증가와 GPU 수요 둔화]]"] <.-> S_T_31["[[T5-02-AI-소프트웨어-레이어의-과점화|T5-02 AI 소프트웨어 레이어의 과점화]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]] — GPU 조달 비용 급증
  - [[T4-01-금리와-데이터센터|T4-01 금리와 데이터센터]] — CAPEX 절감 압박
- ➡️ **동반 및 대체·경쟁 가설**:
  - [[T4-02-엔비디아와-네오클라우드|T4-02 엔비디아와 네오클라우드]] — 엔비디아 락인 vs 자체 칩
  - [[T5-02-AI-소프트웨어-레이어의-과점화|T5-02 AI 소프트웨어 레이어의 과점화]] — 소프트웨어 해자 결합
- 🔽 **파생 및 후행 병목 가설**:
  - [[T1-07-AI-추론-시장-폭발과-LPU-ASIC-분화|T1-07 AI 추론 시장 폭발과 LPU·ASIC 분화]] — 추론용 특화칩 분화
  - [[T1-09-빅테크-커스텀-ASIC-증가와-DSP-생태계|T1-09 빅테크 커스텀 ASIC 증가와 DSP 생태계]] — 디자인하우스 생태계 호황
...
WHERE contains(thesis, "T1-02") OR contains(thesis, "T1-02") OR contains(file.outlinks, this.file.link)
