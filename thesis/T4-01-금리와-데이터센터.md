...
```mermaid
graph LR
    P_T_38["[[T4-05-10년금리-5%-재진입-가능성|T4-05 10년 금리 5% 재진입 가능성]]"] --> T_T_05["★ [[T4-01-금리와-데이터센터|T4-01 금리와 데이터센터]]"]
    T_T_05["★ [[T4-01-금리와-데이터센터|T4-01 금리와 데이터센터]]"] --> D_T_01["[[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]]"]
    T_T_05["★ [[T4-01-금리와-데이터센터|T4-01 금리와 데이터센터]]"] --> D_T_08["[[T4-02-엔비디아와-네오클라우드|T4-02 엔비디아와 네오클라우드]]"]
    T_T_05["★ [[T4-01-금리와-데이터센터|T4-01 금리와 데이터센터]]"] --> D_T_37["[[T4-04-AI-버블-가능성|T4-04 AI 버블 가능성]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T4-05-10년금리-5%-재진입-가능성|T4-05 10년 금리 5% 재진입 가능성]] — 매크로 고금리 장기화
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - [[T2-01-데이터센터의-변화|T3-01 데이터센터의 변화]] — CAPEX ROI 검증 압박
  - [[T4-02-엔비디아와-네오클라우드|T4-02 엔비디아와 네오클라우드]] — GPU 리스 부채 비용 급증
  - [[T4-04-AI-버블-가능성|T4-04 AI 버블 가능성]] — 수익화 지연 시 버블 붕괴
