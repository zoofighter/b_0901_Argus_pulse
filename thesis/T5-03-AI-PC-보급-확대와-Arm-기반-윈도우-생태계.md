...
```mermaid
graph LR
    P_T_04["[[T5-01-온디바이스-AI의-변화|T5-01 온디바이스 AI의 변화]]"] --> T_T_21["★ [[T5-03-AI-PC-보급-확대와-Arm-기반-윈도우-생태계|T5-03 AI PC 보급 확대와 Arm 기반 윈도우 생태계]]"]
    T_T_21["★ [[T5-03-AI-PC-보급-확대와-Arm-기반-윈도우-생태계|T5-03 AI PC 보급 확대와 Arm 기반 윈도우 생태계]]"] <.-> S_T_20["[[T5-02-행동형-AI-에이전트와-모바일-교체-슈퍼사이클|T5-02 행동형 AI 에이전트와 모바일 교체 슈퍼사이클]]"]
```
