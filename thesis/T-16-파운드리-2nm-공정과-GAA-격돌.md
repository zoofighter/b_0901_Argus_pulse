...
```mermaid
graph LR
    P_T_02["[[T-02-메모리-산업의-변화|T-02 메모리 산업의 변화]]"] --> T_T_16["★ [[T-16-파운드리-2nm-공정과-GAA-격돌|T-16 파운드리 2nm 공정과 GAA 격돌]]"]
    P_T_10["[[T-10-첨단-패키징과-CoWoS의-병목|T-10 첨단 패키징과 CoWoS의 병목]]"] --> T_T_16["★ [[T-16-파운드리-2nm-공정과-GAA-격돌|T-16 파운드리 2nm 공정과 GAA 격돌]]"]
    T_T_16["★ [[T-16-파운드리-2nm-공정과-GAA-격돌|T-16 파운드리 2nm 공정과 GAA 격돌]]"] --> D_T_24["[[T-24-빅테크-커스텀-ASIC-증가와-DSP-생태계|T-24 빅테크 커스텀 ASIC 증가와 DSP 생태계]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T-02-메모리-산업의-변화|T-02 메모리 산업의 변화]] — HBM4 베이스 다이 선단 파운드리 요구
  - [[T-10-첨단-패키징과-CoWoS의-병목|T-10 첨단 패키징과 CoWoS의 병목]] — 파운드리-패키징 턴키 수주
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - [[T-24-빅테크-커스텀-ASIC-증가와-DSP-생태계|T-24 빅테크 커스텀 ASIC 증가와 DSP 생태계]] — 빅테크 2nm 공정 선점 경쟁
...
WHERE contains(thesis, "T-16") OR contains(file.outlinks, this.file.link)
