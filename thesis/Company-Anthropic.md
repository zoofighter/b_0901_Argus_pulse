...
- **$5,000억 매출 갭과 ROI 딜레마**: **[[T4-06-오픈AI·앤트로픽의-5000억달러-매출-갭과-데이터센터-ROI-딜레마|T4-06]]** (AI 인프라 CapEx 정당화를 위한 기업용 매출 검증)
- **AI 소프트웨어 과점화**: **[[T5-02-AI-소프트웨어-레이어의-과점화|T5-02]]** (Claude 기반 엔터프라이즈 코딩/워크플로우 자동화)
- **AI 인프라 버블 및 과잉 리스크**: **[[T4-04-AI-버블-가능성|T4-04]]** (추론 비용 및 GPU 감가상각 부담)
