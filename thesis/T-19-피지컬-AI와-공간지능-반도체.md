...
```mermaid
graph LR
    P_T_01["[[T-01-데이터센터의-변화|T-01 데이터센터의 변화]]"] --> T_T_19["★ [[T-19-피지컬-AI와-공간지능-반도체|T-19 피지컬 AI와 공간지능 반도체]]"]
    P_T_04["[[T-04-온디바이스-AI의-변화|T-04 온디바이스 AI의 변화]]"] --> T_T_19["★ [[T-19-피지컬-AI와-공간지능-반도체|T-19 피지컬 AI와 공간지능 반도체]]"]
    T_T_19["★ [[T-19-피지컬-AI와-공간지능-반도체|T-19 피지컬 AI와 공간지능 반도체]]"] --> D_T_17["[[T-17-휴머노이드-로봇과-액추에이터-공급망|T-17 휴머노이드 로봇과 액추에이터 공급망]]"]
    T_T_19["★ [[T-19-피지컬-AI와-공간지능-반도체|T-19 피지컬 AI와 공간지능 반도체]]"] --> D_T_18["[[T-18-End-to-End-AI-자율주행과-로보택시|T-18 End-to-End AI 자율주행과 로보택시]]"]
    T_T_19["★ [[T-19-피지컬-AI와-공간지능-반도체|T-19 피지컬 AI와 공간지능 반도체]]"] --> D_T_27["[[T-27-AI-스마트-글래스와-경량-AR-광학계|T-27 AI 스마트 글래스와 경량 AR 광학계]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T-01-데이터센터의-변화|T-01 데이터센터의 변화]] — 물리 엔진 학습 컴퓨트
  - [[T-04-온디바이스-AI의-변화|T-04 온디바이스 AI의 변화]] — 엣지 공간 지능 추론
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - [[T-17-휴머노이드-로봇과-액추에이터-공급망|T-17 휴머노이드 로봇과 액추에이터 공급망]] — 물리 에이전트 구동
  - [[T-18-End-to-End-AI-자율주행과-로보택시|T-18 End-to-End AI 자율주행과 로보택시]] — 완전자율주행 구현
  - [[T-27-AI-스마트-글래스와-경량-AR-광학계|T-27 AI 스마트 글래스와 경량 AR 광학계]] — 공간 컴퓨팅 인터페이스
...
WHERE contains(thesis, "T-19") OR contains(file.outlinks, this.file.link)
