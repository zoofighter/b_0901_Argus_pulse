...
```mermaid
graph LR
    P_T_04["[[T-04-온디바이스-AI의-변화|T-04 온디바이스 AI의 변화]]"] --> T_T_25["★ [[T-25-오픈소스-모델-고도화와-온프레미스-사설-AI|T-25 오픈소스 모델 고도화와 온프레미스 사설 AI]]"]
    T_T_25["★ [[T-25-오픈소스-모델-고도화와-온프레미스-사설-AI|T-25 오픈소스 모델 고도화와 온프레미스 사설 AI]]"] --> D_T_26["[[T-26-소버린-AI와-국가-단위-컴퓨트-인프라|T-26 소버린 AI와 국가 단위 컴퓨트 인프라]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T-04-온디바이스-AI의-변화|T-04 온디바이스 AI의 변화]] — 오픈소스 가중치 모델 경량화
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - [[T-26-소버린-AI와-국가-단위-컴퓨트-인프라|T-26 소버린 AI와 국가 단위 컴퓨트 인프라]] — 사설/국가 인프라 구축
...
WHERE contains(thesis, "T-25") OR contains(file.outlinks, this.file.link)
