...
```mermaid
graph LR
    P_T_06["[[T2-11-TPU-증가와-GPU-수요-둔화|T2-11 TPU 증가와 GPU 수요 둔화]]"] --> T_T_31["★ [[T4-02-AI-소프트웨어-레이어의-과점화|T4-02 AI 소프트웨어 레이어의 과점화]]"]
    P_T_08["[[T6-09-엔비디아와-네오클라우드|T3-04 엔비디아와 네오클라우드]]"] --> T_T_31["★ [[T4-02-AI-소프트웨어-레이어의-과점화|T4-02 AI 소프트웨어 레이어의 과점화]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T2-11-TPU-증가와-GPU-수요-둔화|T2-11 TPU 증가와 GPU 수요 둔화]] — 빅테크 수직 계열화
  - [[T6-09-엔비디아와-네오클라우드|T3-04 엔비디아와 네오클라우드]] — 클라우드-모델 락인
- ➡️ **동반 및 대체·경쟁 가설**:
  - (해당 없음)
- 🔽 **파생 및 후행 병목 가설**:
  - (해당 없음)
