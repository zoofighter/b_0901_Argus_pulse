...
```mermaid
graph LR
    P_T_01["[[T-01-데이터센터의-변화|T-01 데이터센터의 변화]]"] --> T_T_07["★ [[T-07-CXL-메모리의-확대|T-07 CXL 메모리의 확대]]"]
    P_T_02["[[T-02-메모리-산업의-변화|T-02 메모리 산업의 변화]]"] --> T_T_07["★ [[T-07-CXL-메모리의-확대|T-07 CXL 메모리의 확대]]"]
    T_T_07["★ [[T-07-CXL-메모리의-확대|T-07 CXL 메모리의 확대]]"] --> D_T_28["[[T-28-3D-DRAM-기술-전환과-400단-V-NAND|T-28 3D DRAM 기술 전환과 400단 V-NAND]]"]
    T_T_07["★ [[T-07-CXL-메모리의-확대|T-07 CXL 메모리의 확대]]"] <.-> S_T_02["[[T-02-메모리-산업의-변화|T-02 메모리 산업의 변화]]"]
```

- 🔼 **선행 가설 (배경 요인 & 상위 인프라)**:
  - [[T-01-데이터센터의-변화|T-01 데이터센터의 변화]] — 서버 메모리 용량 병목
  - [[T-02-메모리-산업의-변화|T-02 메모리 산업의 변화]] — HBM 고가격 보완 필요
- ➡️ **동반 및 대체·경쟁 가설**:
  - [[T-02-메모리-산업의-변화|T-02 메모리 산업의 변화]] — HBM vs CXL 보완 관계
- 🔽 **파생 및 후행 병목 가설**:
  - [[T-28-3D-DRAM-기술-전환과-400단-V-NAND|T-28 3D DRAM 기술 전환과 400단 V-NAND]] — DRAM 풀링 아키텍처
...
WHERE contains(thesis, "T-07") OR contains(file.outlinks, this.file.link)
