...
```mermaid
flowchart LR
    P_SMR["[[T2-03-SMR과-데이터센터-무탄소-전력-PPA|T3-03 SMR 전력]]"] <.- 브릿지 -.-> T_Main["★ [[T2-09-온사이트-가스터빈과-연료전지-자체발전|T3-09 온사이트 자체발전]]"]
    T_Main --> D_DC["[[T2-01-데이터센터의-변화|T3-01 데이터센터 전력 자립]]"]
```
