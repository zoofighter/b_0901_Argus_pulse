...
```mermaid
graph LR
    P_T_04["[[T3-02-온디바이스-AI의-변화|T3-02 온디바이스 AI의 변화]]"] --> T_T_18["★ [[T3-04-End-to-End-AI-자율주행과-로보택시|T3-04 End-to-End AI 자율주행과 로보택시]]"]
    P_T_19["[[T3-05-피지컬-AI와-공간지능-반도체|T3-05 피지컬 AI와 공간지능 반도체]]"] --> T_T_18["★ [[T3-04-End-to-End-AI-자율주행과-로보택시|T3-04 End-to-End AI 자율주행과 로보택시]]"]
    T_T_18["★ [[T3-04-End-to-End-AI-자율주행과-로보택시|T3-04 End-to-End AI 자율주행과 로보택시]]"] --> D_T_17["[[T3-03-휴머노이드-로봇과-액추에이터-공급망|T3-03 휴머노이드 로봇과 액추에이터 공급망]]"]
```
