...
```mermaid
flowchart LR
    P_2nm["[[T2-04-파운드리-2nm-공정과-GAA-격돌|T2-04 2nm 파운드리]]"] -->|미세 패턴 광량 부족| T_Main["★ [[TC-01-자유전자레이저-FEL-노광원|TC-01 FEL 광원 상용화]]"]
    T_Main -->|차세대 EUV 로드맵| D_Mem["[[T2-01-메모리-산업의-변화|T2-01 1c/1d D램 미세화]]"]
```
