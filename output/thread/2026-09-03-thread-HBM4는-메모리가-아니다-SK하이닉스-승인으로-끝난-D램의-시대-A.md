...
5. [[T2-01-메모리-산업의-변화|T2-01]]]thesis대로 메모리가 원자재에서 커스텀 ASIC으로 넘어가는 변곡점이 2025년 3분기에 터졌음, YoY 마진 스프레드가 3배 벌어지는 구간임[^4]
...
* [^4]: **Argus Pulse Investment Thesis & Internal Knowledge**
  - 가설 문서: `[[T2-01-메모리-산업의-변화|T-02 메모리 산업의 변화]]` (HBM4로 인한 범용 DRAM의 커스텀 ASIC화)
